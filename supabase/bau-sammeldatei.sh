...
--
-- HINWEIS: Diese Datei wird aus den sechs Einzeldateien zusammengesetzt.
...
KOPF
for f in supabase/schuljahr_v1_schema.sql supabase/schuljahr_v2_vertraege.sql supabase/schuljahr_v3_zahlungen.sql supabase/schuljahr_v4_unterschrift.sql supabase/schuljahr_v5_vertragsabschluss.sql supabase/schuljahr_v6_unterzeichnung.sql; do
  echo ""; echo "-- #############################################################################"
