          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px'}}>
            <div style={{backgroundColor: '#f5f0e8', borderRadius: '12px', padding: '24px', border: '1px solid #e0d8cc'}}>
              ...
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                ...
                <button onClick={() => kaufen('Gleichungen Klasse 8', 3.99)} style={{backgroundColor: '#5b9bd5', color: 'white', border: 'none', borderRadius: '8px', padding: '8px 18px', fontSize: '13px', fontWeight: '600', cursor: 'pointer'}}>Kaufen</button>
              </div>
            </div>
            <div style={{backgroundColor: '#f5f0e8', borderRadius: '12px', padding: '24px', border: '1px solid #e0d8cc'}}>
              ...
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                ...
                <button onClick={() => kaufen('Bruchrechnung einfach erklärt', 2.99)} style={{backgroundColor: '#5b9bd5', color: 'white', border: 'none', borderRadius: '8px', padding: '8px 18px', fontSize: '13px', fontWeight: '600', cursor: 'pointer'}}>Kaufen</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{maxWidth: '1100px', margin: '0 auto'}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px'}}>
            <div style={{backgroundColor: '#ffffff', borderRadius: '12px', padding: '24px', border: '1px solid #e0d8cc'}}>
              ...
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                <span style={{fontSize: '18px', fontWeight: '700', color: '#5b9bd5'}}>2,99 €</span>
                <button onClick={() => kaufen('Physik Formeln Klasse 9', 2.99)} style={{backgroundColor: '#5b9bd5', color: 'white', border: 'none', borderRadius: '8px', padding: '8px 18px', fontSize: '13px', fontWeight: '600', cursor: 'pointer'}}>Kaufen</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px'}}>
            <div style={{backgroundColor: '#f5ead0', borderRadius: '12px', padding: '24px', border: '1px solid #e0cc99'}}>
              ...
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                ...
                <button onClick={() => kaufen('Mathe Sommer Klasse 8→9', 9.99)} style={{backgroundColor: '#c8960c', color: 'white', border: 'none', borderRadius: '8px', padding: '8px 18px', fontSize: '13px', fontWeight: '600', cursor: 'pointer'}}>Kaufen</button>
              </div>
            </div>
            <div style={{backgroundColor: '#f5ead0', borderRadius: '12px', padding: '24px', border: '1px solid #e0cc99'}}>
              ...
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                ...
                <button onClick={() => kaufen('Abitur Vorbereitung Mathe', 14.99)} style={{backgroundColor: '#c8960c', color: 'white', border: 'none', borderRadius: '8px', padding: '8px 18px', fontSize: '13px', fontWeight: '600', cursor: 'pointer'}}>Kaufen</button>
              </div>
            </div>
          </div>
        </div>
