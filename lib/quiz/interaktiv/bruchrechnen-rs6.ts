...
const BRUCHRECHNEN_RS6: Aufgabe[] = [
  ...
  { typ: "input", frage: "Berechne 5/6 − 1/2. (Vollständig gekürzt.)", loesung: ["1/3", "2/6"], platzhalter: "z. B. 1/3", erklaerung: "1/2 = 3/6. Dann 5/6 − 3/6 = 2/6 = 1/3." },
  { typ: "input", frage: "Berechne 1/2 · 4/5. (Vollständig gekürzt.)", loesung: ["2/5", "4/10"], platzhalter: "z. B. 2/5", erklaerung: "Zähler mal Zähler, Nenner mal Nenner: 4/10 = 2/5." },
  ...
  { typ: "input", frage: "Eine Pizza hat 8 Stücke, 2 werden gegessen. Welcher Bruchteil bleibt übrig? (Vollständig gekürzt.)", loesung: ["3/4", "6/8"], platzhalter: "z. B. 3/4", erklaerung: "Übrig sind 6 von 8 Stücken: 6/8 = 3/4." },
