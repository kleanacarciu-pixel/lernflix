...
const WAHRSCHEINLICHKEIT_GYM7: Aufgabe[] = [
  ...
  { typ: "input", frage: "Wie wahrscheinlich ist eine gerade Zahl (2, 4, 6) beim Würfeln? (Als Bruch.)", loesung: ["1/2", "3/6"], platzhalter: "z. B. 1/2", erklaerung: "3 günstige von 6 möglichen: 3/6 = 1/2." },
  ...
  { typ: "input", frage: "Wie wahrscheinlich würfelst du eine Zahl kleiner als 3 (also 1 oder 2)? (Als Bruch.)", loesung: ["1/3", "2/6"], platzhalter: "z. B. 1/3", erklaerung: "2 günstige von 6: 2/6 = 1/3." },
  ...
  { typ: "input", frage: "In einer Klasse mit 20 Kindern tragen 5 eine Brille. Wie wahrscheinlich ist es, zufällig ein Brillenkind auszuwählen? (Als Bruch.)", loesung: ["1/4", "5/20"], platzhalter: "z. B. 1/4", erklaerung: "5 von 20: 5/20 = 1/4." },
